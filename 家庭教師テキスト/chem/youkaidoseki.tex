...
\begin{itemize}
    ...
    \item [(2)]\ce{Fe(OH)3 <=> Fe^3+ + 3OH-}なので，$K_{sp}=[\ce{Fe^3+}][\ce{OH-}]^3$である．
\end{itemize}
...
\end{ascolorbox11}
\begin{exque}
塩化銀は水１Lに対して，25$~^\circ$Cで$1.9$mg溶ける．
\begin{itemize}
    \item [(1)]25$~^\circ$Cにおける塩化銀の飽和水溶液中の\ce{Ag+}のモル濃度を求めよ．
    \item [(2)]25$~^\circ$Cにおける塩化銀の溶解度積を求めよ．
